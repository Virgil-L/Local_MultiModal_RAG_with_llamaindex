...
class CustomOllamaMultiModal(MultiModalLLM):
    ...
    # TODO:
    # def init_model(self, preserve_time) -> None:
    ...
    def chat(
        ...
        ollama_messages: Sequence[Dict[str, Any]], # directly pass the ollama_messages
    ...
    def complete(
        self,
        prompt: str,
        images: List[str], # directly pass the base64 images
